...
if __name__ == "__main__":
    print("line 40: peter begin the main()"
    lg = rdkit.RDLogger.logger() 
    lg.setLevel(rdkit.RDLogger.CRITICAL)
    print("line 43: peter in the main()"
    ...
    print("line 55: peter in the main()"
    pool = Pool(args.ncpu) 
    random.seed(1)

    if args.mode == 'pair':
        #dataset contains molecule pairs
        print("line 61: peter in the main()"
        with open(args.train) as f:
            data = [line.strip("\r\n ").split()[:2] for line in f]

        random.shuffle(data)
        print("line 66: peter in the main()"
        ...
        print("line 73: peter in the main()"
        ...
        all_data = pool.map(func, batches)
        num_splits = max(len(all_data) // 1000, 1)
        print("line 92: peter in the main()"
        le = (len(all_data) + num_splits - 1) // num_splits
        ...
        for split_id in range(num_splits):
            ...
            with open('tensors-%d.pkl' % split_id, 'wb') as f:
                pickle.dump(sub_data, f, pickle.HIGHEST_PROTOCOL)
        print("line 101: peter in the main()"
    elif args.mode == 'single':
        #dataset contains single molecules
        print("line 104: peter in the main()"
        with open(args.train) as f:
        ...
        le = (len(all_data) + num_splits - 1) // num_splits
        print("line 116: peter in the main()"
        for split_id in range(num_splits):
            st = split_id * le
            sub_data = all_data[st : st + le]
            ...
            with open('tensors-%d.pkl' % split_id, 'wb') as f:
                pickle.dump(sub_data, f, pickle.HIGHEST_PROTOCOL)
        print("line 123: peter end the main()"
